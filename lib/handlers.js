...
app.post('/changeTaskStatus', hasFields('todoId', 'taskId'), changeTaskStatus);
app.post('/changeTitle', hasFields('id', 'title'), changeTitle);
app.post('/changeTask', hasFields('todoId', 'taskId', 'task'), changeTask);
app.post('/searchByTask', hasFields('text'), searchByTask);
app.post('/searchByTitle', hasFields('text'), search);
